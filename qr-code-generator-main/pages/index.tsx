...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>QR Code Generator by GauravTripathi</title>
      ...
      <main className={styles.main}>
        <div className={styles.container}>
          <h1 className={styles.title}>
            QR Code Generator By Gaurav Tripathi
          </h1>
        ...
        <footer className={styles.footer}>
          <a href="#" target="_blank" rel="noopener noreferrer">
            Made by{' '}
            <Image src="#4" className={styles.fooImg} alt="Logo" width={100} height={100} />
            <span>Gaurav Tripathi</span>
          </a>
        </footer>
      </main>
    </>
